...
/**
 * Implementation of the RS256 RSASSA-PKCS1-v1_5 JSON Web Signature Backend.
 *
 * @see {@link https://www.rfc-editor.org/rfc/rfc7518.html#section-3.3 | RS256 JWS Algorithms}
 */
export class RS256JwsBackend extends RSASSAJwsBackend {
  /**
   * Name of the JSON Web Signature Algorithm used by the Backend.
   */
  protected override readonly algorithm: JwsAlg = 'RS256';
