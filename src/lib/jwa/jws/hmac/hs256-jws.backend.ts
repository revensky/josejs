...
/**
 * Implementation of the HS256 HMAC JSON Web Signature Backend.
 *
 * @see {@link https://www.rfc-editor.org/rfc/rfc7518.html#section-3.2 | HMAC JWS Algorithm}
 */
export class HS256JwsBackend extends HMACJwsBackend {
  /**
   * Name of the JSON Web Signature Algorithm used by the Backend.
   */
  protected override readonly algorithm: JwsAlg = 'HS256';
   ...
   */
  protected readonly keySize: number = 32;
}
